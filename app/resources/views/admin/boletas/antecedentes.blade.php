        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                	...
                	{!!Form::select('adato1', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
                <div class="form-group col-md-6">
                    {!!Form::label('adato2','Antecedentes de 3 o más abortos espontáneos consecutivos:')!!}
                	{!!Form::select('adato2', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
                	{!!Form::label('adato3','Antecedentes de 3 o más gestas:')!!}
                	{!!Form::select('adato3', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
                <div class="form-group col-md-6">
                    {!!Form::label('adato4','Peso al nacer del último bebe < 2500 g. (5 lb. 8 onz.):')!!}
                	{!!Form::select('adato4', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
                	{!!Form::label('adato5','Peso al nacer del último bebe > 4500 g. (9 lb. 4 onz.):')!!}
                	{!!Form::select('adato5', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                	...
                	{!!Form::select('adato7', config('cboOptions'), null, ['class' => 'form-control', 'required' => 'required'])!!}
                </div>
            </div>
            {{-- <div class="row">
