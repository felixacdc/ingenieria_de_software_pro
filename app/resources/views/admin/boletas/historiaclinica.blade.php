        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="form-group col-md-12 text-right">
                    <a href="#tabData3" data-id="menuItem3" data-toggle="tab" class="btn btn-primary nextButton"><i class="fa fa-arrow-left"></i></a>
                    <a href="#tabData5" data-id="menuItem5" data-toggle="tab" class="btn btn-primary nextButton"><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
